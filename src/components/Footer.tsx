...
const translations = {
  ...
  ar: {
    name: 'إسلام',
    tagline: 'معرفة إسلامية',
    footer: {
      desc: 'منصة مخصصة لنشر المعرفة الإسلامية الأصيلة عبر التقنية الحديثة ومشاركة المجتمع بصورة مبسطة وموثوقة.',
      resources: 'الموارد',
      community: 'المجتمع',
      rights: '© 2026 إسلام. جميع الحقوق محفوظة.',
...
export const Footer = ({ lang }: { lang: Language }) => {
  ...
  )}&su=${encodeURIComponent(lang === 'en' ? 'Support Request - Islam' : 'طلب دعم - إسلام')}`;
          ...
          <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12">
            <div>
              ...
              <ul className="space-y-4 text-app-muted text-sm">
                <li>
                  <Link to="/prayer" className="hover:text-app-accent transition-colors">
                    {t.prayer}
                  </Link>
                </li>
                <li>
